...
public class MesiboAppConfig {
    ...
    public static class Configuration {
        ...
        public String phone = "";
        public String cc = "";
        public MesiboSampleAPI.Invite invite = null;
    ...
    public static MesiboAppConfig getInstance() {
        return _instance;
    }
    ...
    private static MesiboAppConfig _instance  = null;
    public MesiboAppConfig(Context c) {
        _instance = this;
        mContext = c;

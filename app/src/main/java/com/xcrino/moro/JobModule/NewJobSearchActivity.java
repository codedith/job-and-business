...
import com.xcrino.moro.Adapter.IndustryAdapter;
...
public class NewJobSearchActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_job_search);
        mContext = this;
        getLayoutInitUI();
    ...
    private void getLayoutInitUI() {
        ...
        ll_recent_search = (LinearLayout) findViewById(R.id.ll_recent_search);
                ...
                try {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            Intent intent = new Intent(mContext, JobSearchBySearchButton.class); //previous EmpoyeeNewJobActivity is used here

...
//import com.xcrino.chatterapp.Adapter.IndustryAdapter;
//import com.xcrino.chatterapp.Interface.ApiInterface;
//import com.xcrino.chatterapp.PojoModels.DefaultData;
//import com.xcrino.chatterapp.PojoModels.PostedJobsList;
//import com.xcrino.chatterapp.PojoModels.ReceivedSavedJobsCandidates;
//import com.xcrino.chatterapp.PojoModels.StateListData;
...
//
//public class EmployeeJobSearchActivity extends AppCompatActivity implements View.OnClickListener {
//
//    Context mContext;
...
//
//
//        appPreferencesShared.setSearchedList(null);
//
...
//                    countryName = location[0].trim();
//                    stateName = location[1].trim();
//                    if (NetworkStatus.isNetworkAvailable(mContext)) {
//                        postJobSearchByCandidateMethod();
//                    } else {
//                        Toast.makeText(mContext, "Please Check Internet Connection!", Toast.LENGTH_SHORT).show();
...
//                                    recycler_view.setAdapter(new IndustryAdapter(mContext, industryNameArrayList));
//                                } else {
...
//
//        ApiInterface apiInterface = ApiClients.getClient().create(ApiInterface.class);
//        Call<PostedJobsList> postJobSearchByCandidate = apiInterface.postJobSearchByCandidateMethod("Mogo_api/job_search_by_candidate/" + appPreferencesShared.getUserId().toString(), skill, countryName, stateName);
...
//                            Intent intent = new Intent(mContext, EmployeeNewJobActivity.class);
...
//
//        ApiInterface apiInterface = ApiClients.getClient().create(ApiInterface.class);
//        Call<ReceivedSavedJobsCandidates> postCandidateSearchByRecruiterMethod = apiInterface.postCandidateSearchByRecruiterMethod(appPreferencesShared.getUserId(),skill, countryName, stateName);

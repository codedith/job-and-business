...
public class JobSearchByIndustryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_search_by_industry);
        context = this;
        getLayoutUiId();

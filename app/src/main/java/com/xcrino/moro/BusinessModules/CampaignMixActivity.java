...
public class CampaignMixActivity extends AppCompatActivity implements View.OnClickListener {

    private TextView toolbar_title;
    private ImageView back_arrow, image_uploaded;
    private Context mContext;
    private AppPreferencesShared appPreferencesShared;
    CardView upload_image_mix;
    EditText uploaded_text_mix;
    Button boostNewButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campaign_mix);

        mContext = this;
        checkAndRequestPermissions();
        getInituiId();
        toolbar_title.setText("Mix Campaign Mode");
        validations = new Validations();
        back_arrow.setOnClickListener(this);
        upload_image_mix.setOnClickListener(this);
        boostNewButton.setOnClickListener(this);
    }

    private void getInituiId() {
        toolbar_title = (TextView) findViewById(R.id.toolbar_title);
        back_arrow = (ImageView) findViewById(R.id.back_arrow);
        upload_image_mix = findViewById(R.id.upload_image_mix);
        uploaded_text_mix = findViewById(R.id.uploaded_text_mix);
        image_uploaded = findViewById(R.id.image_uploaded);
        boostNewButton = findViewById(R.id.boostNewButton);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.upload_image_mix:
                showUploadDialogue();
                break;

            case R.id.boostNewButton:
                if (validations.isMandatory(uploaded_text_mix.getText().toString(), uploaded_text_mix)) {
                    if (uploaded_text_mix.getText().length() <= 4000) {
    ...
    private void uploadMixCampaignMethod() {
        if (uploaded_image == null || uploaded_image.isEmpty()) {
            Toast.makeText(mContext, "Please Upload an Image", Toast.LENGTH_SHORT).show();
            return;
        } else {
            ...
            RequestBody campaignMode = RequestBody.create(MediaType.parse("text/plain"), "mix");
            RequestBody text = RequestBody.create(MediaType.parse("text/plain"), uploaded_text_mix.getText().toString());
